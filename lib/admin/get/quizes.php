<?php
	...
	if ($_SESSION["teacher"] == "2")
	{
		...
		if ($result->num_rows > 0) 
		{
			...
			{
				echo '<div class="course-item col-md-4"><h2 id="' . $row["ID"] . '">' . $row["Name"] . '</h2><br><a href="#" role="button" class="btn btn-raised btn-success">Edit »</a>' . ' <a href="' . $row["Link"] . '/results" role="button" class="btn btn-default active">View results »</a></div>';
			}
		} 
	}
